    ...
    res.send(`
        ...
        <div class="card">
            ...
            <form action="/send-verify" method="POST" id="regForm">
                ...
                <div class="label-sm">圖形驗證碼 (點擊刷新)</div>
        ...
        <script>
            ...
            form.onsubmit = function(e) {
                ...
                if (capInput.value.toUpperCase() !== currentCaptcha) {
                    ...
                    capInput.value = ""; // 清空驗證碼輸入
                    drawCaptcha();       // 刷新 Canvas 圖片
                    regBtn.disabled = true;
                    return false;
                }
...
app.post('/check-verify', (req, res) => {
    ...
    if (record && record.code.toString() === userCode) {
        ...
        res.send(`${style}<div class="card text-center"><div class="logo">AUTHORIZED</div><hr><a href="/" class="btn btn-primary">LOG_IN</a></div>`);
    } else {
